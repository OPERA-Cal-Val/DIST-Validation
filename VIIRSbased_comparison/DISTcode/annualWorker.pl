...
$outbase = "/gpfs/glad3/HLSDIST/VIIRStest/lasrc_timeSeries/DIST-ANN_v1_VIIRSb";if(!-d $outbase){mkdir"$outbase";}
#TSmodels/1_shutdown5obs3months/DIST-ANN";#VFModel/Drone/LP-DAAC/DIST-ANN";
$sourcebase = "/gpfs/glad3/HLSDIST/VIIRStest/lasrc_timeSeries/DIST-ALERT_v1_VIIRSb";#LP-DAAC/DIST-ALERT";#TSmodels/1_shutdown5obs3months/";
$DISTversion="v1";
