...
def runGranule(server,granule,mode="ALL"):
  ...
  #subprocess.run(["cp /gpfs/glad3/HLSDIST/testing/v1sample/DIST-ALERT_v1/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_GEN-ANOM.tif "+outdir+"/"+DIST_ID+"_GEN-ANOM.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  #subprocess.run(["cp /gpfs/glad3/HLSDIST/testing/v1sample/DIST-ALERT_v1/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_VEG-ANOM.tif "+outdir+"/"+DIST_ID+"_VEG-ANOM.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  #subprocess.run(["cp /gpfs/glad3/HLSDIST/testing/v1sample/DIST-ALERT_v1/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_VEG-IND.tif "+outdir+"/"+DIST_ID+"_VEG-IND.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  #subprocess.run(["cp /gpfs/glad3/HLSDIST/testing/v1sample/DIST-ALERT_v1/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_DATA-MASK.tif "+outdir+"/"+DIST_ID+"_DATA-MASK.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  #subprocess.run(["cp /gpfs/glad3/HLSDIST/testing/v1sample/DIST-ALERT_v1/"+year+"/"+tilepathstring+"/"+DIST_ID+"/additional/HLSsourceFiles.txt "+outdir+"/additional/HLSsourceFiles.txt  2>>errorLOG.txt"],capture_output=True,shell=True)
  #subprocess.run(["cp /gpfs/glad3/HLSDIST/testing/v1sample/DIST-ALERT_v1/"+year+"/"+tilepathstring+"/"+DIST_ID+"/additional/VFsourceFiles.txt "+outdir+"/additional/VFsourceFiles.txt  2>>errorLOG.txt"],capture_output=True,shell=True)
  
  subprocess.run(["cp DIST-ALERT_v1_VIIRS/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_GEN-ANOM.tif "+outdir+"/"+DIST_ID+"_GEN-ANOM.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  subprocess.run(["cp DIST-ALERT_v1_VIIRS/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_VEG-ANOM.tif "+outdir+"/"+DIST_ID+"_VEG-ANOM.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  subprocess.run(["cp DIST-ALERT_v1_VIIRS/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_VEG-IND.tif "+outdir+"/"+DIST_ID+"_VEG-IND.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  subprocess.run(["cp DIST-ALERT_v1_VIIRS/"+year+"/"+tilepathstring+"/"+DIST_ID+"/"+DIST_ID+"_DATA-MASK.tif "+outdir+"/"+DIST_ID+"_DATA-MASK.tif  2>>errorLOG.txt"],capture_output=True,shell=True)
  subprocess.run(["cp DIST-ALERT_v1_VIIRS/"+year+"/"+tilepathstring+"/"+DIST_ID+"/additional/HLSsourceFiles.txt "+outdir+"/additional/HLSsourceFiles.txt  2>>errorLOG.txt"],capture_output=True,shell=True)
  subprocess.run(["cp DIST-ALERT_v1_VIIRS/"+year+"/"+tilepathstring+"/"+DIST_ID+"/additional/VFsourceFiles.txt "+outdir+"/additional/VFsourceFiles.txt  2>>errorLOG.txt"],capture_output=True,shell=True)
...
if __name__=='__main__':
  ...
  serverlist = [(23,30),("01",30),("02",30),("03",30),("04",30),("05",30),("06",30)]#[(17,60),(15,15),(16,20)]
  processes = []
