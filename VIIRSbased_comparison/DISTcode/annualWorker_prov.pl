...
$outbase = "/gpfs/glad3/HLSDIST/VIIRStest/lasrc_timeSeries/DIST-ANN_v1_current";if(!-d $outbase){mkdir"$outbase";}
#TSmodels/1_shutdown5obs3months/DIST-ANN";#VFModel/Drone/LP-DAAC/DIST-ANN";
$sourcebase = "/gpfs/glad3/HLSDIST/VIIRStest/lasrc_timeSeries/DIST-ALERT_v1_current";#LP-DAAC/DIST-ALERT";#TSmodels/1_shutdown5obs3months/";
$DISTversion="v1";
...
for(y=0; y<ysize; y++) {for(x=0; x<xsize; x++){
    if(vegstatus[y][x]!=255 and outvegstatus[y][x]==255){outvegstatus[y][x]=0;}
...
for(y=0; y<ysize; y++) {for(x=0; x<xsize; x++) {
  if(outvegstatus[y][x]==0 or outvegstatus[y][x]==255 ){//outvegconf[y][x]<confidenceThreshold and outvegconf[y][x]>=0){//formerly == 0
    outveghist[y][x] = 200;
    outveganommax[y][x] = 0;
    outvegcount[y][x] = 0;
...
for(y=0; y<ysize; y++) {for(x=0; x<xsize; x++){
	if(genstatus[y][x]!=255 and outgenstatus[y][x]==255){outgenstatus[y][x]=0;}
